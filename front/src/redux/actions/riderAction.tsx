...
export const acceptActionHandler =
  (orderId: string, orderType: "Order" | "NewOrder") =>
  async (dispatch: any) => {
    try {
      const endpoint =
        orderType === "Order" ? "/rider/acceptOrder" : "/rider/acceptNewOrder";
...
export const completeActionHandler =
  (orderId: string, orderType: string) => async (dispatch: any) => {
    try {
...
export const makingMenuHandler =
  (orderId: string, orderType: string) => async (dispatch: any) => {
    try {
...
export const goToClientHandler =
  (orderId: string, orderType: string) => async (dispatch: any) => {
    try {
