      ...
      <ScrollView style={styles.contentContainer}>
        <View style={styles.termsSection}>
          ...
          <Text style={styles.termsText}>
            (주)사우스세른(South Sern)은 이용자의 권익 및 개인 정보 보호에 만전을 기하고자 관계법령의 규정을 반영하여 사우스세른에 회원가입을 신청하시는 이용자에게 아래와 같이 개인 정보의 수집·이용 목적, 수집하는 개인 정보의 항목, 개인 정보의 보유 및 이용기간을 안내해 드립니다.
          </Text>
          ...
          <View style={styles.bulletList}>
            <Text style={styles.bulletItem}>• 법령 및 사우스세른의 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정 도용 및 부정 거래 방지, 약관 개정 등의 고지사항 전달, 분쟁 조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.</Text>
