        ...
        <View style={styles.termsSection}>
          ...
          <View style={styles.bulletList}>
            ...
            <View style={[styles.bulletList, styles.nestedList]}>
              ...
              <Text style={styles.bulletItem}>• 러너 매칭 후 5분 초과 ~ 10분 이내 취소: 서비스 비에서 1000원 과금 후 나머지 전액 환불</Text>
              <Text style={styles.bulletItem}>• 러너매칭 후 10분 초과 ~ 20분 이내 취소: 서비스 비에서 3000원 과금 후 나머지 전액 환불</Text>
              <Text style={styles.bulletItem}>• 러너 매칭 후 20분 초과 취소: 서비스 비에서 5000원 과금 후 나머지 전액 환불</Text>
...
<View style={[styles.bulletList, styles.nestedList]}>
  ...
  <Text style={styles.bulletItem}>• 러너 매칭 후 서비스 시간 기준 1시간 ~ 2시간 전 취소: 서비스 비에서 1000원 과금 후 나머지 전액 환불</Text>
  <Text style={styles.bulletItem}>• 러너 매칭 후 서비스 시간 기준 1시간 이내 취소: 서비스 비에서 3000원 과금 후 나머지 전액 환불</Text>
