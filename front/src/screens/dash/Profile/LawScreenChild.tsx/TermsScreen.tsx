      ...
      <ScrollView style={styles.contentContainer}>
        <View style={styles.termsSection}>
          ...
          <Text style={styles.termsText}>
            (주)세른(Sern (이하 “회사“))는 아이디, 비밀번호, 그리고 휴대전화 번호 인증을 필수로 하여 계정을 생성하실 수 있습니다. 다만, 실제 휴대전화의 소유주임을 확인하기 위해서 가입 당시 인증 절차를 거치게 됩니다. 또한, 다른 모바일 기기에서 서비스 사용을 연속하기 위해서는 기존에 가입하고 인증했던 휴대전화 번호로 재인증을 해야 합니다. 아래의 경우에는 계정 생성을 승인하지 않을 수 있습니다.
          </Text>
