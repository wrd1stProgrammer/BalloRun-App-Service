    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.quickSelectContainer}>
          ...
          >
            <Text style={[selectedType === "home" && styles.selectedText]}>
              🏠 우리집
            </Text>
          </Pressable>
          <Pressable
          ...
          >
            <Text style={[selectedType === "work" && styles.selectedText]}>
              🏢 회사
            </Text>
          </Pressable>
          <Pressable
            style={[
              styles.quickButton,
              selectedType === "other" && styles.selectedButton,
            ]}
            onPress={() => setSelectedType("other")}
          >
            <Text style={[selectedType === "other" && styles.selectedText]}>
              📍 기타
            </Text>
          </Pressable>
        </View>
