...
type OrderPageScreenRouteProp = RouteProp<
  RootStackParamList,
  "OrderPageScreen"
>;
...
const OrderPageScreen = () => {
  ...
  const handleNextPress = () => {
    const total = Number(priceOffer || "0") + Number(deliveryFee || "0");

    if (total < 1000) {
      Alert.alert(
        "금액 부족",
        "주문상품 가격과 배달팁의 합계는 1,000원 이상이어야 합니다."
      );
      return;
    }
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={styles.content}>
                <View style={styles.sectionHeader}>
                  ...
                  >
                    <Ionicons
                      name={images ? "close" : "camera-outline"}
                      size={24}
                      color="#000"
                    />
                  </TouchableOpacity>
                ...
                <View style={styles.priceInputContainer}>
                  <TextInput
                    ...
                    value={priceOffer}
                    onChangeText={(text) =>
                      handlePriceChange(text, setPriceOffer)
                    }
                  />
                ...
                <View style={styles.priceInputContainer}>
                  <TextInput
                    ...
                    value={deliveryFee}
                    onChangeText={(text) =>
                      handlePriceChange(text, setDeliveryFee)
                    }
                  />
                  <Text style={styles.wonText}>원</Text>
                </View>
              ...
              <TouchableOpacity
                style={[
                  styles.nextButton,
                  !orderDetails && styles.nextButtonInactive,
                ]}
